...
/* 0x01D7 */ DEFINE_ACTOR(Low_Table, ACTOR_LOW_TABLE, ACTOROVL_ALLOC_NORMAL, "Low_Table")
/* 0x01D8 */ DEFINE_ACTOR(Nul_Box, ACTOR_NUL_BOX, ACTOROVL_ALLOC_NORMAL, "Nul_Box")
/* 0x01D9 */ DEFINE_ACTOR(the_dev, ACTOR_THE_DEV, ACTOROVL_ALLOC_NORMAL, "the_dev")
/* 0x01DA */ DEFINE_ACTOR(Tele, ACTOR_TELE, ACTOROVL_ALLOC_NORMAL, "Tele")
/* 0x01DB */ DEFINE_ACTOR(Barrel, ACTOR_BARREL, ACTOROVL_ALLOC_NORMAL, "Barrel")
/* 0x01DC */ DEFINE_ACTOR(Patrol_Guard, ACTOR_PATROL_GUARD, ACTOROVL_ALLOC_NORMAL, "Patrol_Guard")
/* 0x01DD */ DEFINE_ACTOR(Check_Spot, ACTOR_CHECK_SPOT, ACTOROVL_ALLOC_NORMAL, "Check_Spot")