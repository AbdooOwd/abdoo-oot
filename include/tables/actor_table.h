...
/* 0x01D7 */ DEFINE_ACTOR(Low_Table, ACTOR_LOW_TABLE, ACTOROVL_ALLOC_NORMAL, "Low_Table")
			 DEFINE_ACTOR(Nul_Box, ACTOR_NUL_BOX, ACTOROVL_ALLOC_NORMAL, "Nul_Box")
			 DEFINE_ACTOR(the_dev, ACTOR_THE_DEV, ACTOROVL_ALLOC_NORMAL, "the_dev")
			 DEFINE_ACTOR(Tele, ACTOR_TELE, ACTOROVL_ALLOC_NORMAL, "Tele")
			 DEFINE_ACTOR(Barrel, ACTOR_BARREL, ACTOROVL_ALLOC_NORMAL, "Barrel")
			 DEFINE_ACTOR(Patrol_Guard, ACTOR_PATROL_GUARD, ACTOROVL_ALLOC_NORMAL, "Patrol_Guard")